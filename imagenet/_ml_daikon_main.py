...
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(cudnn).instrument()
import torch.distributed as dist
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(dist).instrument()
import torch.multiprocessing as mp
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(mp).instrument()
import torch.nn as nn
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(nn).instrument()
import torch.nn.parallel
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(torch.nn.parallel).instrument()
import torch.optim
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(torch.optim).instrument()
import torch.utils.data
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(torch.utils.data).instrument()
import torch.utils.data.distributed
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(torch.utils.data.distributed).instrument()
import torchvision.datasets as datasets
import torchvision.models as models
import torchvision.transforms as transforms
from torch.optim.lr_scheduler import StepLR
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(StepLR).instrument()
from torch.utils.data import Subset
from mldaikon.instrumentor.tracer import Instrumentor
Instrumentor(Subset).instrument()
